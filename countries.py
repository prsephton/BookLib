...
{'timezones': ['Europe/Vienna'],
				...
				'capital': 'Vienna'},
{'timezones': ['Australia/Lord_Howe', 'Australia/Hobart', 'Australia/Currie',
...
{'timezones': ['America/La_Paz'],
				...
				'capital': 'Sucre'},
{'timezones': ['America/Noronha', 'America/Belem', 'America/Fortaleza',
...
{'timezones': ['America/St_Johns', 'America/Halifax', 'America/Glace_Bay',
               ...
               'America/Montreal', 'America/Toronto', 'America/Nipigon',
               'America/Thunder_Bay', 'America/Pangnirtung', 'America/Iqaluit',
               'America/Atikokan', 'America/Rankin_Inlet', 'America/Winnipeg',
               'America/Rainy_River', 'America/Cambridge_Bay', 'America/Regina',
               'America/Swift_Current', 'America/Edmonton', 'America/Yellowknife',
               'America/Inuvik', 'America/Dawson_Creek', 'America/Vancouver',
...
{'timezones': ['Africa/Abidjan'],
				'code': 'CI', 'continent': 'Africa', 'name': u"C\xc3\xb4te d'Ivoire",
...
{'timezones': ['Asia/Shanghai', 'Asia/Harbin', 'Asia/Chongqing', 'Asia/Urumqi', 'Asia/Kashgar'],
				'code': 'CN', 'continent': 'Asia', 'name': "People's Republic of China",
				'capital': 'Beijing'},
...
{'timezones': ['Africa/Blantyre'],
				...
				'capital': 'Lilongwe'},
{'timezones': ['America/Mexico_City', 'America/Cancun', 'America/Merida',
...
{'timezones': ['Europe/Bucharest'],
				...
				'capital': 'Bucharest'},
{'timezones': ['Europe/Kaliningrad', 'Europe/Moscow', 'Europe/Volgograd', 'Europe/Samara',
...
{'timezones': ['Africa/Sao_Tome'],
				'code': 'ST', 'continent': 'Africa',
                'name': u'S\xc3\xa3o Tom\xc3\xa9 and Pr\xc3\xadncipe',
				'capital': u'S\xc3\xa3o Tom\xc3\xa9'},
...
{'timezones': ['America/New_York', 'America/Detroit', 'America/Kentucky/Louisville',
               ...
               'America/Chicago', 'America/Indiana/Vincennes', 'America/Indiana/Petersburg',
               'America/Menominee', 'America/North_Dakota/Center',
               'America/North_Dakota/New_Salem', 'America/Denver', 'America/Boise',
               'America/Shiprock', 'America/Phoenix', 'America/Los_Angeles',
               'America/Anchorage', 'America/Juneau', 'America/Yakutat',
...
class CountryVocabulary(grok.GlobalUtility):
    ...
    def __call__(self, context):
        terms = [SimpleVocabulary.createTerm(c['code'], c['code'], c['name']) for c in g_countries]
